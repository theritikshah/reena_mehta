  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.about}>
        <p>
          Hey there! I&apos;m Reena Mehta, an Indian singer on a musical
          journey. Growing up in the heart of India, I found my voice through
          classical Indian ragas. But I&apos;m not confined by boundaries. I
          explore diverse genres, creating a fusion of melodies that tell
        ...
        <p>
          For me, music is more than a collection of notes; it&apos;s a journey
          of emotions. My lyrics touch hearts, and my melodies linger in souls.
